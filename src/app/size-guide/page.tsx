    ...
    <PageLayout>
      <div className="container mx-auto px-4 py-16 max-w-4xl">
            ...
            <table className="w-full font-serif text-sm">
              <thead>
                <tr className="border-b border-border">
                  ...
                  <th className="text-left py-3 font-display font-normal">Lens Width</th>
                  <th className="text-left py-3 font-display font-normal">Bridge Width</th>
                  <th className="text-left py-3 font-display font-normal">Temple Length</th>
                </tr>
              </thead>
        ...
        <section className="p-8 bg-primary text-primary-foreground">
          <h2 className="font-display text-xl tracking-wide mb-4">{verticalConfig.label} Care Tips</h2>
