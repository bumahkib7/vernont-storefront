          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <MapPin className="h-6 w-6 text-[var(--secondary)] flex-shrink-0 mt-1" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <Phone className="h-6 w-6 text-[var(--secondary)] flex-shrink-0 mt-1" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <Clock className="h-6 w-6 text-[var(--secondary)] flex-shrink-0 mt-1" />
                <div>
            ...
            <div className="mt-12 p-6 bg-secondary">
              <h3 className="text-lg mb-2">Customer Service</h3>
          ...
          <div>
            ...
            {submitted ? (
              <div className="p-8 bg-secondary text-center">
                <h3 className="text-xl mb-4">Thank You!</h3>
                <p className="text-muted-foreground">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-transparent border border-border focus:outline-none focus:border-[var(--secondary)]"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-transparent border border-border focus:outline-none focus:border-[var(--secondary)] resize-none"
