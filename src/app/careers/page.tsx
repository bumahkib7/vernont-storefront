        ...
        <div className="max-w-[1500px] mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              <h3 className="text-xl tracking-wide mb-4">Growth & Development</h3>
            ...
            <div className="text-center">
              <h3 className="text-xl tracking-wide mb-4">Creative Environment</h3>
              <p className="text-muted-foreground">
            ...
            <div className="text-center">
              <h3 className="text-xl tracking-wide mb-4">Global Opportunities</h3>
              <p className="text-muted-foreground">
      ...
      <section className="py-20 bg-secondary">
        <div className="max-w-[1500px] mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl tracking-wide">Open Positions</h2>
          </div>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {openPositions.map((position, index) => (
              <div
                key={index}
                className="p-6 bg-background border border-border hover:border-[var(--foreground)] transition-colors"
              >
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div>
                    <h3 className="text-lg tracking-wide">{position.title}</h3>
