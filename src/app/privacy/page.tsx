    ...
    <PageLayout>
      <div className="max-w-[1500px] mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            <h2 className="text-2xl tracking-wide mb-4">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-2xl tracking-wide mb-4">2. How We Use Your Information</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl tracking-wide mb-4">3. Information Sharing</h2>
          ...
          <section>
            <h2 className="text-2xl tracking-wide mb-4">4. Data Security</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl tracking-wide mb-4">5. Cookies and Tracking</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl tracking-wide mb-4">6. Your Rights</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl tracking-wide mb-4">7. Data Retention</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl tracking-wide mb-4">8. International Transfers</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl tracking-wide mb-4">9. Children&apos;s Privacy</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl tracking-wide mb-4">10. Contact Us</h2>
            <p className="text-muted-foreground leading-relaxed">
