    ...
    const securityHeaders = [
      {
        ...
        value: [
          ...
          "connect-src 'self' https://www.googletagmanager.com https://www.google-analytics.com https://region1.google-analytics.com https://*.analytics.google.com https://stats.g.doubleclick.net https://eu.i.posthog.com https://eu.posthog.com https://us.i.posthog.com https://us.posthog.com https://eu-assets.i.posthog.com https://us-assets.i.posthog.com https://*.klaviyo.com https://api.mapbox.com https://events.mapbox.com https://*.runixcloud.dev https://*.amazonaws.com https://*.workers.dev https://cdn.vernont.com https://images.unsplash.com https://api.stripe.com http://localhost:* http://127.0.0.1:*",
