    ...
    const securityHeaders = [
      {
        ...
        value: [
          ...
          "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://eu-assets.i.posthog.com https://us-assets.i.posthog.com https://api.mapbox.com",
          "style-src 'self' 'unsafe-inline' https://api.mapbox.com https://fonts.googleapis.com",
          "img-src 'self' data: blob: https: http:",
          "font-src 'self' data: https://fonts.gstatic.com",
          "connect-src 'self' https://www.googletagmanager.com https://www.google-analytics.com https://region1.google-analytics.com https://eu.i.posthog.com https://eu.posthog.com https://us.i.posthog.com https://us.posthog.com https://api.mapbox.com https://events.mapbox.com https://*.runixcloud.dev https://*.amazonaws.com https://*.workers.dev https://cdn.vernont.com https://images.unsplash.com http://localhost:* http://127.0.0.1:*",
          "frame-src 'self'",
          "object-src 'none'",
          "base-uri 'self'",
          "form-action 'self'",
